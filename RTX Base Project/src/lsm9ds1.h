...
typedef struct
{
  uint8_t Power_Mode_Output_DataRate;         // DATA RATES 238Hz (for our case)
	uint8_t	Decimation;
	uint8_t Axes_Enable;                        // Axes Enables (XYZ)
	uint8_t BW_select;
...
/* External Sensor DRY interrupt struct */
typedef struct
{
  uint8_t Acc_Int;             
	uint8_t Gyro_Int;             
...
/*******************************************************************************
*  Output registers, Accelerometer X, Y, Z 
...
/*******************************************************************************
*  Output registers, Gyroscope X, Y, Z
...
/** @defgroup STM32F4_DISCOVERY_LSM9DS1_Exported_Functions
  * @{
  */ 
void LSM9DS1_Acc_Init(Ext_Sensor_Struct *LSM9DS1Struct);
void LSM9DS1_Gyro_Init(Ext_Sensor_Struct *LSM9DS1Struct);
void LSM9DS1_INT_Config(EXT_DRY_INT *LSM9DS1_InterruptConfigStruct);
